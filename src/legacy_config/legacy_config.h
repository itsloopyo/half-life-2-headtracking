...
// The HeadTracking.ini reader of v0.2.0, the last build that read that file, frozen so a player
...
// file here by hash.
//
// Three things differ from the reader it was taken from (src/config.cpp at v0.2.0):
...
// Reads the file at `path`, the ANSI path v0.2.0 opened it by, into a default-constructed `c`.
