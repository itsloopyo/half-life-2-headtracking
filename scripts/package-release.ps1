...
$modName = 'HalfLife2HeadTracking'
$modSlug = 'half-life-2-headtracking'
$asi     = 'HalfLife2HeadTracking.asi'
...
# Mod payload deployed to <game>\bin by install.cmd. The mod creates
